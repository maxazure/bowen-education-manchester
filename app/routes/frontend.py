...
async def column_page_generic(
    ...
    if column.column_type == ColumnType.SINGLE_PAGE:
        ...
        try:
            return templates_engine.TemplateResponse(f"{column_slug}.html", context)
        except TemplateNotFound:
            logger.debug(
                f"Custom template {column_slug}.html not found, using default single_page.html"
            )
            return templates_engine.TemplateResponse("single_page.html", context)
        ...
        try:
            ...
            return templates_engine.TemplateResponse("product_list.html", context)
        ...
        try:
            ...
            return templates_engine.TemplateResponse("post_list.html", context)
        ...
        return templates_engine.TemplateResponse("gallery.html", context)
        ...
        if column_slug.endswith("-gallery") or column_slug == "gallery":
            ...
            if column_slug == "gallery":
                ...
                try:
                    return templates_engine.TemplateResponse("gallery_list.html", context)
                except TemplateNotFound:
        ...
        if column_slug == "events":
            ...
            try:
                return templates_engine.TemplateResponse("events.html", context)
            except TemplateNotFound:
        ...
        if child_columns:
            ...
            return templates_engine.TemplateResponse("overview.html", context)
...
async def item_detail_page_generic(
    ...
    if column.column_type == ColumnType.PRODUCT:
        ...
        return templates_engine.TemplateResponse("product_detail.html", context)
        ...
        return templates_engine.TemplateResponse("post_detail.html", context)
