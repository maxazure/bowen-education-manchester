...
def register_routes(app: FastAPI):
    """注册所有路由"""
    # 先注册管理后台路由（在通配符路由之前）
    from admin.app.routers import auth, media, columns, single_pages, posts, products, settings, galleries, contacts, dashboard, home, column_builder, static_pages, stats
