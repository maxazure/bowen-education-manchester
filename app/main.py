...
def register_routes(app: FastAPI):
    ...
    app.include_router(columns.router, prefix="/admin/columns", tags=["admin-columns"])
    app.include_router(single_pages.router, prefix="/admin/pages", tags=["admin-pages"])
    app.include_router(posts.router, prefix="/admin/posts", tags=["admin-posts"])
    app.include_router(products.router, prefix="/admin/products", tags=["admin-products"])
    app.include_router(settings.router, prefix="/admin/settings", tags=["admin-settings"])
    app.include_router(galleries.router, prefix="/admin/galleries", tags=["admin-galleries"])
    app.include_router(heroes.router, prefix="/admin/heroes", tags=["admin-heroes"])
    app.include_router(contacts.router, prefix="/admin/contacts", tags=["admin-contacts"])
    app.include_router(home.router, prefix="/admin/home", tags=["admin-home"])
    app.include_router(column_builder.router, prefix="/admin/columns", tags=["admin-columns-builder"])
    app.include_router(static_pages.router, prefix="/admin/static-pages", tags=["admin-static-pages"])
